...
const ValidateRequest = (functionName: string, schema: Joi.ObjectSchema<any>, options: Joi.ValidationOptions = defaultValidationOptions) => {
  ...
  return wrapValidator(validator, functionName);
};
